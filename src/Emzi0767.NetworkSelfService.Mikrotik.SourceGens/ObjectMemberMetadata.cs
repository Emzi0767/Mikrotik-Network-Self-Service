...
/// </summary>
public readonly struct ObjectMemberMetadata
{
    /// <summary>
    ...
    /// <summary>
    /// Creates new object member metadata.
    /// </summary>
    ...
    public ObjectMemberMetadata(string name, string type, string serializedName)
    {
        this.Name = name;
        this.Type = type;
